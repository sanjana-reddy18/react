...
const Skills = () => {
  return (
    <Fade right>
      ...
      <div className="w-fit flex flex-col bg-white mx-auto p-3 rounded">
        <img src={CompanyImg} alt="company" className="w-60 mx-auto" />
        <div className="mx-auto text-black">
          <span className="font-bold text-black">Work Experience Role:</span>{" "}
          Worked as Associate Developer
        </div>
      </div>
    </Fade>
  );
